<?php
	...
	if(isset($_GET['id']))
	{
		...
		{
			$dato = $_GET['id'];
			$sql = $conn->query("select * from docentes where id like '%$dato%'");
...
<body style="background-color:	#AFEEEE ;">
    ...
    <div class="row">  
		...
		<h4 style="color:	#0000CD"  align="center">REGISTRO ACADEMICO</h4>
		</div>
		</div>

	   
        <div class="col-md-11 caja1">
		<h4 style="color:	#0000CD" align="center">Modificar Datos Docentes</h4>
		</div>
	...
	<form action="<?PHP echo $_SERVER['PHP_SELF'];?>" method="post">
        ...
        <div class="col-md-11 caja1">
		<h4 style="color:	#0000CD" align="center">Modificar </h4>
			...
			<input type="button" onclick="location.href='consiltarDocente.php'" name="Volver" value="Volver a la consulta de datos">
...
<?php
	if($_POST)
	{
		try
		{
			if(isset($_POST['id']))
			{
				$sql = $conn->exec("UPDATE docentes SET nombres='".$_POST['nombres']."',apellidos='".$_POST['apellidos']."' WHERE id='".$_POST['id']." ' ");
