...
<div class="row">
	...
	<input  type="button" name="Enviar" id="" value="Registro nuevo" onClick="location.replace('pgGuardarDocente.php')"></div>
    <div class="col-md-4 rojo2"align="center">
	...
	if(isset($_POST["buscar"])){
		try{
			...
			while($row = $sql->fetch(PDO::FETCH_ASSOC))
			{
				echo '<tr>';
				echo '<td>
						<a href="pgModificarDocentes.php? id='.$row['id'].'"><img src="../img/modificar.png" width="20"></a></td>';
				echo '<td>
						<a href="pgEliminarDocentes.php? id='.$row['id'].'"><img src="../img/eliminar.png" width="20"></a></td>';
