...
<input type="submit"class="btn btn-primary"name="Enviar"id=""value="Consultar Datos De Docentes">
<input type="text"name="buscar"id=""value="">
</form>
<hr>
<?php include_once"nuevoDocente.php";
?>
</div>
</div>
...
<?php
    if(isset($_POST["buscar"])){
		try{
			$dato = $_POST["buscar"];
			$sql = $conn->query("select * docentes where id like '%$dato%'");
			...
			while($row = $sql->fetch(PDO::FETCH_ASSOC))
			{
				echo '<tr>';
				echo '<td>
						<a href="pgModificarDocente.php?id='.$row['id'].'"><img src="../img/modificar.png" width="20"></a></td>';
				echo '<td>
						<a href="pgEliminarDocente.php?id='.$row['id'].'"><img src="../img/eliminar.png" width="20"></a></td>';
				echo '<td>'.$row['id'].'</td>';
